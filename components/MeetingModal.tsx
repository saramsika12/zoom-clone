...
const MeetingModal = ({ isOpen, onClose, title, className, children, handleClick,
    buttonText, image, buttonIcon }: MeetingModalProps
) => {
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            ...
            flex-col gap-6 border-none bg-dark-1 px-6 py-9 text-white'>
                ...
                <div className='flex flex-col gap-6'>
                    {image && (
                        <div className='flex justifu-center'>
                            <Image
                                src={image}
                                alt='image'
                                width={72}
                    ...
                    ' onClick={handleClick}>
                        {buttonIcon && (
                            <Image
                                src={buttonIcon} alt='button icon'
                                width={13} height={13} />
                        )}
